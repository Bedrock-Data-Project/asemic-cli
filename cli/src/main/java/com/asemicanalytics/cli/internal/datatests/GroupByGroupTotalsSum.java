...
public class GroupByGroupTotalsSum extends DataTest {
  private final Optional<String> kpi;
  private final Optional<String> groupBy;
  private final LocalDate date;

  public GroupByGroupTotalsSum(String appId, String name,
                               Optional<String> kpi,
  ...
  public TestResult run(CachingChartClient queryEngineClient) {
    ...
    expected.replaceAll((k, v) -> Math.round(v * 100.0) / 100.0);
